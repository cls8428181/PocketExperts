...
@interface ViewController (){
    ...
    DiscoverTableViewController * _discoverTVC;
...
- (void)settingTitleView
{
    ...
    _expertVC = [[ExpertViewController alloc] initWithNibName:@"ExpertViewController" bundle:nil];
    
    _expertVC.view.frame = CGRectMake(0, 44, ScreenW, ScreenH);
    
    _discoverTVC = [[DiscoverTableViewController alloc] initWithNibName:@"DiscoverTableViewController" bundle:nil];
