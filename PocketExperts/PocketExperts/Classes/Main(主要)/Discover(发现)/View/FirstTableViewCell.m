...
- (void)awakeFromNib {
    // Initialization code
    self.expert1 = [[ExpertPicAndName alloc] initWithFrame:CGRectMake(70, 75, 60, 70)];
    [self.contentView addSubview:_expert1];
    self.expert2 = [[ExpertPicAndName alloc] initWithFrame:CGRectMake(135, 75, 60, 70)];
    [self.contentView addSubview:_expert2];
    self.expert3 = [[ExpertPicAndName alloc] initWithFrame:CGRectMake(200, 75, 60, 70)];
