...
- (void)createSubviews
{
    ...
    self.professor1 = [[ProfessorView alloc] initWithFrame:CGRectMake(40, 210+40, (Width-60)/5, Width/10+65)];
    [self.contentView addSubview:_professor1];
    self.professor2 = [[ProfessorView alloc] initWithFrame:CGRectMake(40+(Width-60)/5, 210+40, (Width-60)/5, Width/10+65)];
    [self.contentView addSubview:_professor2];
    self.professor3 = [[ProfessorView alloc] initWithFrame:CGRectMake(40+(Width-60)/5*2, 210+40, (Width-60)/5, Width/10+65)];
    [self.contentView addSubview:_professor3];
    self.professor4 = [[ProfessorView alloc] initWithFrame:CGRectMake(40+(Width-60)/5*3, 210+40, (Width-60)/5, Width/10+65)];
    [self.contentView addSubview:_professor4];
    self.professor5 = [[ProfessorView alloc] initWithFrame:CGRectMake(40+(Width-60)/5*4, 210+40, (Width-60)/5, Width/10+65)];
